...
extern int CreateWav(char *,struct wavHeader *,uid_t,gid_t);
...
extern int RecordWavFile(char *,char *,int,struct wavHeader *,
			 struct wavProcess *,unsigned,uid_t,gid_t);
...
extern int WriteTimerChunk(char *,struct wavTimer *,int);
extern struct wavTimer *ReadTimerChunk(char *,int *);
